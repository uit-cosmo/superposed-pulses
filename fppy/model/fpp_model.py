...
import fppy.model.two_point_forcing as tpfrc
...
class TwoPointFPPModel(AbstractModel):
    """Model for a two point filtered process containing all model parameters and responsible of
    generating a realization of the processes through make_realization.
    ...
    def __init__(self, gamma: float, total_duration: float, dt: float):
        ...
        self._forcing_generator: tpfrc.TwoPointForcingGenerator = (
            tpfrc.TwoPointForcingGenerator()
        )
